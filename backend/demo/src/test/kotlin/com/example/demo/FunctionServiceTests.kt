...
class FunctionServiceTests @Autowired constructor(
    ...
    private val configuredFunction1 = ConfiguredFunction("kanzi.Global$1.compare", 0.09236394624248921, 0.17315721808227894)
    private val configuredFunction2 = ConfiguredFunction("kanzi.Global.<clinit>", 8.61869990570836, 15.618572522029455)
